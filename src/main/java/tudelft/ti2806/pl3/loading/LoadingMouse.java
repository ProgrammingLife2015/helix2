...
public class LoadingMouse implements LoadingObserver {
	...
	/**
	 * Is called when a {@link LoadingObservable} notifies his {@link LoadingObserver}.
	 * If the arguments are true, the application must be loading,
	 * so a Wait cursor is displayed, otherwise the normal mouse is displayed.
	 *
