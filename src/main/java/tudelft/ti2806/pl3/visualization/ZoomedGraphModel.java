...
import tudelft.ti2806.pl3.data.wrapper.operation.collapse.CollapseOnSpace;
...
public class ZoomedGraphModel extends Observable implements Observer {
	...
	// TODO: Set somewhere?
	private double panelWidth = 1920;
	...
	public void produceDataNodeWrapperList() {
		...
		((CombineWrapper) collapsedNode).setShouldUnfold(true);
