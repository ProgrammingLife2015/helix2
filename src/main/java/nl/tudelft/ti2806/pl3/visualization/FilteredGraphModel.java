package nl.tudelft.ti2806.pl3.visualization;
...
import nl.tudelft.ti2806.pl3.data.wrapper.operation.collapse.CalculateCollapseOnSpace;
import nl.tudelft.ti2806.pl3.data.wrapper.operation.interest.ComputeInterest;
import nl.tudelft.ti2806.pl3.data.wrapper.operation.yposition.PositionNodeYOnGenomeSpace;
import nl.tudelft.ti2806.pl3.data.wrapper.util.WrapUtil;
import nl.tudelft.ti2806.pl3.util.CollectInterest;
 ...
 * <li>Then it notifies the {@link nl.tudelft.ti2806.pl3.visualization.ZoomedGraphModel}, which will produce the data for
...
public class FilteredGraphModel extends Observable implements LoadingObservable {
    ...
    /**
     * Filters a copy of the {@link nl.tudelft.ti2806.pl3.data.graph.GraphDataRepository} and combines all nodes which
