 ...
 * {@link nl.tudelft.ti2806.pl3.data.wrapper.HorizontalWrapper}.
 * <p/>
 * <p>
 * It creates two {@link nl.tudelft.ti2806.pl3.data.wrapper.HorizontalWrapper}s in
 * a {@link nl.tudelft.ti2806.pl3.data.wrapper.HorizontalWrapper} to verify that
...
public class SingleWrapperUnwrapTest {
    ...
    /**
     * Create four {@link nl.tudelft.ti2806.pl3.data.wrapper.DataNodeWrapper} s and
     * wrap these in two separate
     * {@link nl.tudelft.ti2806.pl3.data.wrapper.HorizontalWrapper}s.
     */
    @Before
    public void before() {
     ...
     * {@link nl.tudelft.ti2806.pl3.data.wrapper.WrapperClone}s.
     */
    @Test
    ...
    /**
     * Verify that no more
     * {@link nl.tudelft.ti2806.pl3.data.wrapper.WrapperPlaceholder}s are left.
     */
    @Test
