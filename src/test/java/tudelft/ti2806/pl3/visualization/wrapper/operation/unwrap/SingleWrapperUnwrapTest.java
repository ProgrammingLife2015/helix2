 ...
 * {@link tudelft.ti2806.pl3.visualization.wrapper.HorizontalWrapper}.
 *
 * <p>
 * It creates two
 * {@link tudelft.ti2806.pl3.visualization.wrapper.HorizontalWrapper}s in a
 * {@link tudelft.ti2806.pl3.visualization.wrapper.HorizontalWrapper} to verify
...
public class SingleWrapperUnwrapTest {
	...
	/**
	 * Create four {@link tudelft.ti2806.pl3.visualization.wrapper.NodePosition}
	 * s and wrap these in two separate
	 * {@link tudelft.ti2806.pl3.visualization.wrapper.HorizontalWrapper}s.
	 */
	@Before
	public void before() {
	...
	public void testLeftNode() {
		...
		assertTrue(((DataNodeWrapper) left).getDataNodeList().contains(
				dataNode1));
	}
	...
	public void testMiddleNode() {
		...
		assertTrue(((DataNodeWrapper) leftMiddle).getDataNodeList().contains(
				dataNode2));
		assertTrue(((DataNodeWrapper) leftMiddle.getIncoming().get(0))
	...
	public void testRightNode() {
		...
		assertTrue(((DataNodeWrapper) rightMiddle).getDataNodeList().contains(
				dataNode3));
		assertTrue(((DataNodeWrapper) rightMiddle.getIncoming().get(0))
				.getDataNodeList().contains(dataNode2));
	}
	
	/**
	 * Verify that we indeed get four
	 * {@link tudelft.ti2806.pl3.visualization.wrapper.DataNodeWrapper}s.
	 */
	@Test
	...
	/**
	 * Verify that no more
	 * {@link tudelft.ti2806.pl3.visualization.wrapper.PlaceholderWrapper}s are
	 * left.
	 */
	@Test
