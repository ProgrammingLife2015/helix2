...
public class NodeYPositionTest {
	...
	public void testVerticalWrappedWithNullContainer() throws FileNotFoundException {
		...
		assertEquals(0.5f, verticalWrapper.getNodeList().get(0).getySpace(), DELTA);
		assertEquals(0.25f, verticalWrapper.getNodeList().get(0).getY(), DELTA);
		assertEquals(0.4f, verticalWrapper.getNodeList().get(1).getySpace(), DELTA);
	...
	@Test
	public void testHorizontalWrappedWithNullContainer() throws FileNotFoundException {
