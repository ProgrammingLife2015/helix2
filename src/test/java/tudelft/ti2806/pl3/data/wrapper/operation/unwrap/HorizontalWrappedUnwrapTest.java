 ...
 *
 * <p>
 * It creates two {@link HorizontalWrapper}s in a {@link HorizontalWrapper} to
 * verify that the wrappers are recursively unwrapped.
 * </p>
 * <p>
...
public class HorizontalWrappedUnwrapTest {
	...
	/**
	 * Create four {@link DataNodeWrapper}s and wrap these in two separate
	...
	public void testLeftMiddleNode() {
		...
		assertTrue(leftMiddle.getDataNodes().contains(dataNode2));
		assertTrue(leftMiddle.getIncoming().get(0).getDataNodes().contains(dataNode1));
	}
	...
	public void testRightMiddleNode() {
		...
		assertTrue(rightMiddle.getDataNodes().contains(dataNode3));
		assertTrue(rightMiddle.getIncoming().get(0).getDataNodes().contains(dataNode2));
	}
	 ...
	 * @return a {@link HorizontalWrapper} containing wrapper1 and wrapper2
	 */
	private HorizontalWrapper getHorizontalWrapper(Wrapper wrapper1,
			Wrapper wrapper2) {
