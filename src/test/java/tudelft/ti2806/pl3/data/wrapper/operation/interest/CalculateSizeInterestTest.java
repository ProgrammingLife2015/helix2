...
public class CalculateSizeInterestTest {
	...
	public void testHorizontalWrapper() {
		...
		when(horizontalWrapper.getBasePairCount()).thenReturn(wrapperSize);
	...
	public void testVerticalWrapper() {
		...
		when(verticalWrapper.getBasePairCount()).thenReturn(wrapperSize);
	...
	public void testSpaceWrapper() {
		...
		when(spaceWrapper.getBasePairCount()).thenReturn(wrapperSize);
	...
	public void testSingleWrapper() {
		...
		when(singleWrapper.getBasePairCount()).thenReturn(wrapperSize);
