...
public enum AminoAcid {
	...
	private static final int CODONS = (int) Math.pow(Gene.values().length,
			CODON_SIZE);
	 ...
	 * 
	 * @return the array with for each possible codon the resulting {@code AminoAcid}
	 */
	 ...
	 * 
	 * @param gene an array of the genes to be read
